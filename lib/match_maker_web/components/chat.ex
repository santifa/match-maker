defmodule MatchMakerWeb.Components.Chat do
  @moduledoc """
  `MatchMakerWeb.Components.Chat` is a Phoenix LiveView component module for creating customizable chat interfaces.
