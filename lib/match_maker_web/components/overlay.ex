defmodule MatchMakerWeb.Components.Overlay do
  @moduledoc """
  The `MatchMakerWeb.Components.Overlay` module provides a versatile overlay component for
  ...
  The `MatchMakerWeb.Components.Overlay` is perfect for creating modal backgrounds, loading screens,
