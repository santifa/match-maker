defmodule MatchMakerWeb.Components.NativeSelect do
  @moduledoc """
  The `MatchMakerWeb.Components.NativeSelect` module provides a customizable native select component
  ...
  With built-in error handling and custom error messages, `MatchMakerWeb.Components.NativeSelect`
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(MatchMakerWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(MatchMakerWeb.Gettext, "errors", msg, opts)
    end
  end
end
