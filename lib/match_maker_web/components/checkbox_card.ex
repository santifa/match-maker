defmodule MatchMakerWeb.Components.CheckboxCard do
  @moduledoc """
  The `MatchMakerWeb.Components.CheckboxCard` module provides a customizable checkbox card component for Phoenix LiveView
