defmodule MatchMakerWeb.Components.Menu do
  @moduledoc """
  The `MatchMakerWeb.Components.Menu` module is designed to render a hierarchical menu structure in
  ...
  The `MatchMakerWeb.Components.Menu` is ideal for creating multi-level navigation menus in
  ...
  import MatchMakerWeb.Components.Accordion, only: [accordion: 1]
  import MatchMakerWeb.Components.Button, only: [button_link: 1]
