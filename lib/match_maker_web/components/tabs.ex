defmodule MatchMakerWeb.Components.Tabs do
  @moduledoc """
  `MatchMakerWeb.Components.Tabs` is a Phoenix component module that provides a highly customizable tab
  ...
  import MatchMakerWeb.Components.Badge, only: [badge: 1]
