defmodule MatchMakerWeb.Components.Footer do
  @moduledoc """
  The `MatchMakerWeb.Components.Footer` module provides a customizable footer component for Phoenix applications,
