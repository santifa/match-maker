defmodule MatchMakerWeb.Components.Alert do
  @moduledoc """
  MatchMakerWeb.Components.Alert module provides collection of alert components and helper functions for managing and displaying alerts
