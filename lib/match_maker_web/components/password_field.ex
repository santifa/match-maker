defmodule MatchMakerWeb.Components.PasswordField do
  @moduledoc """
  The `MatchMakerWeb.Components.PasswordField` module is a Phoenix component designed to render a customizable
  ...
  defp translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      ...
      Gettext.dgettext(MatchMakerWeb.Components.PasswordField.Gettext, "errors", msg, opts)
    end
  end
end
