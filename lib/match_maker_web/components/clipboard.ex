defmodule MatchMakerWeb.Components.Clipboard do
  @moduledoc """
  The `MatchMakerWeb.Components.Clipboard` is a Phoenix LiveView component module for creating customizable clipboard functionality.
