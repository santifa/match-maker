defmodule MatchMakerWeb.Components.CheckboxField do
  @moduledoc """
  MatchMakerWeb.Components.CheckboxField Module Provides a customizable checkbox component for use in Phoenix LiveView forms.
