defmodule MatchMakerWeb.Components.ScrollArea do
  @moduledoc """
  The `MatchMakerWeb.Components.ScrollArea` module provides a customizable scroll area component for Phoenix LiveView
