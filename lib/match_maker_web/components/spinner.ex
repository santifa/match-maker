defmodule MatchMakerWeb.Components.Spinner do
  @moduledoc """
  The `MatchMakerWeb.Components.Spinner` module provides a dynamic and customizable loading spinner
  ...
  With its flexible design, the `MatchMakerWeb.Components.Spinner` module enables developers to provide
