defmodule MatchMakerWeb.Components.MegaMenu do
  @moduledoc """
  The `MatchMakerWeb.Components.MegaMenu` module provides a customizable and interactive mega menu component
