defmodule MatchMakerWeb.Components.Image do
  @moduledoc """
  The `MatchMakerWeb.Components.Image` module provides a component for rendering images in a Phoenix application.
